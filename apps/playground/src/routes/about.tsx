            ...
            <section className="border border-slate-700 bg-slate-800/50 rounded-xl p-6 shadow-lg">
              ...
              <ul className="space-y-2 text-sm text-slate-300">
                ...
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-400" />
                  <span>
                    Optional Hono <code>Context</code> (<code>c</code>) on SSR
                    for headers, cookies, etc.
                  </span>
                </li>
              </ul>

              <p className="mt-4 text-xs text-slate-500">
                Tip: you can reuse this structure as a template for
                documentation or guide pages inside your buna app.
              </p>
            </section>
