...
// ../../node_modules/.bun/react-dom@19.2.0+2f44e903108183df/node_modules/react-dom/cjs/react-dom-client.development.js
...
// ../../node_modules/.bun/react-dom@19.2.0+2f44e903108183df/node_modules/react-dom/client.js
...
// ../../packages/buna/src/client/create-route.ts
var import_client = __toESM(require_client(), 1);
var import_react = __toESM(require_react(), 1);
function parseParamsFromPattern(pathname, pattern) {
  const params = {};
...
function getClientRouteContext() {
  ...
  const params = pattern && pattern !== url.pathname ? parseParamsFromPattern(url.pathname, pattern) : {};
  return { params, searchParams, hash };
}
function resolveMeta(resolver, ctx) {
  if (!resolver)
    return;
  return typeof resolver === "function" ? resolver(ctx) : resolver;
}
function robotsObjectToString(robots) {
  const tokens = [];
  ...
  if (robots.follow !== false)
    tokens.push("follow");
  if (robots.noarchive)
    tokens.push("noarchive");
  if (robots.nosnippet)
    tokens.push("nosnippet");
  if (robots.noimageindex)
    tokens.push("noimageindex");
  if (robots.noodp)
    tokens.push("noodp");
...
function setNamedMeta(name, content) {
  if (!content)
    return;
  let tag = document.head.querySelector(`meta[name="${name}"][data-buna-meta="true"]`);
  if (!tag) {
    tag = document.createElement("meta");
    tag.name = name;
    tag.setAttribute("data-buna-meta", "true");
...
function setPropertyMeta(property, content) {
  if (!content)
    return;
  let tag = document.head.querySelector(`meta[property="${property}"][data-buna-meta="true"]`);
  if (!tag) {
    tag = document.createElement("meta");
...
function setLink(attrs) {
  ...
  if (!href)
    return;
  let tag = document.head.querySelector(`link[rel="${rel}"][href="${href}"][data-buna-meta="true"]`);
  if (!tag) {
...
function clearPreviousBunaTags() {
  const tags = document.head.querySelectorAll('[data-buna-meta="true"]');
  tags.forEach((node) => node.remove());
}
function applyBunaMeta(meta) {
  if (!meta)
    return;
  if (typeof document === "undefined")
    return;
  ...
  if (meta.charset) {
    let charsetTag = document.head.querySelector('meta[charset][data-buna-meta="true"]');
    if (!charsetTag) {
      charsetTag = document.createElement("meta");
      charsetTag.setAttribute("data-buna-meta", "true");
  ...
  if (meta.robots) {
    const robotsContent = typeof meta.robots === "string" ? meta.robots : robotsObjectToString(meta.robots);
  ...
  if (meta.openGraph) {
    ...
    if (og.title)
      setPropertyMeta("og:title", og.title);
    if (og.description)
      setPropertyMeta("og:description", og.description);
    if (og.url)
      setPropertyMeta("og:url", og.url);
    if (og.siteName)
      setPropertyMeta("og:site_name", og.siteName);
    if (og.type)
      setPropertyMeta("og:type", og.type);
    if (og.locale)
      setPropertyMeta("og:locale", og.locale);
  ...
  if (meta.twitter) {
    ...
    if (tw.card)
      setNamedMeta("twitter:card", tw.card);
    if (tw.site)
      setNamedMeta("twitter:site", tw.site);
    if (tw.creator)
      setNamedMeta("twitter:creator", tw.creator);
    if (tw.title)
      setNamedMeta("twitter:title", tw.title);
    if (tw.description)
      setNamedMeta("twitter:description", tw.description);
    if (tw.image)
      setNamedMeta("twitter:image", tw.image);
    if (tw.imageAlt)
      setNamedMeta("twitter:image:alt", tw.imageAlt);
  }
  if (meta.extraMeta) {
...
var AboutPage = createRoute((ctx) => {
  const [count, setCount] = import_react2.useState(0);
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("main", {
    className: "min-h-screen bg-[#0d0d0d] text-slate-100 flex items-center justify-center px-6",
    children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
      className: "w-full flex justify-center flex-col gap-4 max-w-xl text-center",
      children: [
        ...
        /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx_dev_runtime.jsxDEV("code", {
              className: "px-1.5 py-0.5 bg-slate-800 rounded text-emerald-300",
        ...
        /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
          className: "mt-10 border border-slate-700 bg-slate-800/50 rounded-xl p-6 shadow-lg",
          children: [
            /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
              className: "text-xs uppercase tracking-wider text-slate-400 mb-4",
        ...
        /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
          ...
          children: "Built using buna() + Tailwind"
        }, undefined, false, undefined, this)
      ]
    }, undefined, true, undefined, this)
  }, undefined, false, undefined, this);
